...
2. Lock the licence position (AGPL-3.0 for code additions matching upstream; CC BY 4.0 for documentation additions).
3. Document the family pattern and upstream relationship in [`README.md`](https://git.unitek-systems.com/UniCORE/UniSaaS.UniCORE.Loki/src/branch/main/README.md) (mirror: [GitHub](https://github.com/bryanunitek/UniSaaS.UniCORE.Loki/blob/main/README.md)).
4. Document the merge discipline in [`UPSTREAM-MERGE-DISCIPLINE.md`](https://git.unitek-systems.com/UniCORE/UniSaaS.UniCORE.Loki/src/branch/main/UPSTREAM-MERGE-DISCIPLINE.md) (mirror: [GitHub](https://github.com/bryanunitek/UniSaaS.UniCORE.Loki/blob/main/UPSTREAM-MERGE-DISCIPLINE.md)).
